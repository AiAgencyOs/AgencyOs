...
- **The reading that fills it (G-249, 2026-09-16)** §3.1's six scheduling intents read on every
  inbound client message — four of them read and deliberately not acted on — with §3.1's
  explicit/ambiguous as a field and §4.2/§4.3's dates and ranges resolved against the agency's
  local date. A past time drops the time, not the request. `meeting.request_read`, the fourth
  subscriber on `message.received`; it answers nobody
...
had asked for a meeting (**G-248**, closed), and nothing read a message to notice that they
did (**G-249**, closed 2026-09-16). The record had been read; the system had not been run.
