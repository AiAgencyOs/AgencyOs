...
supabase/       231 migrations, 88 tables across 9 schemas, RLS on all 88
tests/          191 files · 847 suites · 4,147 tests (2026-09-13)
scripts/        93 scripts, 79 live verifications wired into CI
```
