...
| **G-120** | Leads converted before G-086 keep a null qualification date | `leads_qualified_at_set` is `NOT VALID`, so historic rows are not refused | A decision on whether to backfill | C | P3 | G-086 | None | **ADM-76 — open**: backfill, and with what date? The conversion date is the only defensible candidate and is still a guess; the alternative is a visible hole rather than invented history | 5 |
...
| Class | Count |
| --- | --- |
| A — already implemented or fixed | 95 |
| B — partial | 2 |
| C — missing | 16 |
| D — incorrect | 0 |
...
**78 Admin decisions** have been raised across these gaps; **69 are granted, 9
