...
Counted from the 106 gap records in `docs/roadmap/roadmap.json`, which is the
...
| Class | Count |
| --- | --- |
| A — already implemented or fixed | 86 |
| B — partial | 5 |
| C — missing | 13 |
| D — incorrect | 1 |
