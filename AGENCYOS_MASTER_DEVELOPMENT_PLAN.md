...
Counted from the 107 gap records in `docs/roadmap/roadmap.json`, which is the
...
| Class | Count |
| --- | --- |
| A — already implemented or fixed | 88 |
| B — partial | 4 |
| C — missing | 13 |
| D — incorrect | 1 |
