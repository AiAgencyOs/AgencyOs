...
Counted from the 108 gap records in `docs/roadmap/roadmap.json`, which is the
...
| Class | Count |
| --- | --- |
| A — already implemented or fixed | 89 |
| B — partial | 4 |
| C — missing | 13 |
| D — incorrect | 1 |
...
**71 Admin decisions** have been raised across these gaps; **63 are granted, 8
