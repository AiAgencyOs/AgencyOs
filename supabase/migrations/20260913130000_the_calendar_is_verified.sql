-- ═══════════════════════════════════════════════════════════════════════════
-- The calendar, verified — G-242 (ADM-102)
--
-- The Google Calendar + Meet adapter registers when the owner places its
-- credential in the deployment environment. Configured is not verified: the
-- Meetings page gains a control that makes one real free/busy read and
-- records the moment and the calendar through the one audited settings door,
-- exactly as G-236 did for WhatsApp and the AI provider. core.set_organization_setting
-- is carried forward VERBATIM from 20260912130000 with two marked edits.
-- ═══════════════════════════════════════════════════════════════════════════
